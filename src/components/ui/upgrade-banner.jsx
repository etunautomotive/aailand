    ...
    <div className={cn('mx-auto flex items-center justify-center', className)}>
      <AnimatePresence>
        ...
        >
          ...
          <div className="relative flex h-[35px] items-center gap-1 rounded-[6px] border border-primary/30 bg-tertiary pl-2.5 pr-1 text-sm">
            <button
              className="focus-visible:shadow-focus-ring rounded-xs my-[-1px] cursor-pointer border-none bg-transparent px-0 py-1 font-sans text-[13px] font-medium text-secondary underline decoration-primary/20 underline-offset-[5px] outline-none hover:text-primary hover:decoration-primary/40 focus-visible:!shadow-[#008FFF]"
            ...
            <span className="text-[0.8125rem] text-secondary/70">
              {description}
            </span>
            {onClose && (
              <button
                onClick={onClose}
                className="m-0 flex h-6 !w-6 shrink-0 cursor-pointer items-center justify-center rounded-[4px] border-0 bg-transparent p-0 text-primary hover:bg-primary/10"
              >
