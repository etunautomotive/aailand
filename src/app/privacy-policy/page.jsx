export default function PrivacyPolicy() {
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl mt-24 lg:mt-32">
      ...
      <div className="space-y-6 text-black dark:text-white">
        <p>
          ...
          your privacy is important. We are committed to protecting the privacy
          of your personally identifiable information collected through our
        ...
        <section>
          ...
          <p>
            When you visit our website, we may collect non-personal data such
            as:
          </p>
        ...
        <section>
          ...
          <p>
            Our website uses essential cookies to ensure basic functionality and
            improve user experience. These include cookies for theme preferences
            and session management. You can adjust your browser settings to
            refuse cookies, though this may limit some website features.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            policy. You may request deletion of your data by contacting us.
          </p>
        </section>
