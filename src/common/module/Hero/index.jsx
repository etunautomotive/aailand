      ...
      <div className="flex flex-col justify-center md:top-0 mt-28 lg:mt-36 items-center">
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="lg:w-[70%] text-center lg:text-2xl mt-16 mb-20 dark:text-neutral-300 text-neutral-700">
            One platform with industry-specific AI agents for every step of the
            automotive sales process—from lead generation to loan approval,
            built with decades of dealership expertise.
          </p>
        </div>
