...
function FreeModuleModal({ isOpen, onOpenChange, submitted, form, onChange, onSubmit }) {
  return (
        ...
        <ModalBody>
          {submitted ? (
            ...
            <form onSubmit={onSubmit} className="flex flex-col gap-2">
              ...
              <button type="submit" className="modern-modal__submit">Submit</button>
            </form>
          )}
        </ModalBody>
        <div className="modal-footer">
          <button className="modern-modal__close" onClick={() => onOpenChange(false)}>Close</button>
        </div>
      </ModalContent>
    </Modal>
  );
    ...
    <div className="flex justify-center w-full">
      <div className="w-full max-w-[1500px] mx-auto">
        <VslHero
          heading={
            <>
              Welcome to the operating system for the <PurpleHighlight>modern dealer.</PurpleHighlight>
            </>
          }
        ...
        <CTASection 
          ...
          testimonial={{
            ...
            position: "Finance Manager — Approval Express Canada — Vancouver, BC"
          }}
